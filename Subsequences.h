...
#ifndef Tarea_3_Tecnicas_Diseno_Subsequences_h
#define Tarea_3_Tecnicas_Diseno_Subsequences_h
#include <stdio.h>
#include <iostream>
#include <vector>
#include <stack>
/*
 ...
 La complejidad de generar la matriz es de O(nxm)
 La complejidad de recorrer la matriz por el camino obtenido es O(n+m)
 */
